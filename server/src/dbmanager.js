...
* Creates a new Event
*/
async function createEvent(orgId, name, price, description, picture, startDate, endDate, location, published, visibility) {
    let sql = `CALL create_event(?,?,?,?,?,?,?,?,?,?);`;

    await db.query(sql, [orgId, name, price, description, picture, startDate, endDate, location, published, visibility]);
}
// -------------------------------------------------------------------------------------------------------
// -------------------------------------------------------------------------------------------------------
...
*/
async function createOrganization(orgNr, name, description, logo, banner, colours, membershipFee, adminFee) {
...
*/
async function getUserPermissions(user_id, org_id) {

    let sql = `CALL get_user_permissions(?, ?);`;

    let res = await db.query(sql, [user_id, org_id]);
